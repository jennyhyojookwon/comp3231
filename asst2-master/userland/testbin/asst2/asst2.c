...
main(int argc, char * argv[])
{
        ...
        fd = open("test2.file", O_RDWR | O_CREAT, 0700); /* mode u=rw in octal */
        ...
        printf("**********\n* opening new file \"test4.file\"\n");
        fd = open("test4.file", O_RDWR | O_CREAT, 0700); /* mode u=rw in octal */
        printf("* open() got fd %d\n", fd);
        if (fd < 0) {
                printf("ERROR opening file: %s\n", strerror(errno));
                exit(1);
        ...
        printf("**********\n* opening old file \"test4.file\"\n");
        fd = open("test4.file", O_RDONLY);
        printf("* open() got fd %d\n", fd);
        if (fd < 0) {
                printf("ERROR opening file: %s\n", strerror(errno));
                exit(1);
